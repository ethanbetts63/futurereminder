    ...
    <>
      ...
      >
        <div className="text-lg text-primary-foreground">
          ...
          <p className="mb-6">We don’t just rely on a push notification. FutureReminder will reach out via email, SMS and backup contacts if necessary. You can designate emergency contacts, and in extreme cases, we can reach out manually through social channels. Overkill? Maybe—but missing these types of reminders can have serious consequences.</p>
